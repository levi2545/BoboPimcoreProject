...
path = '/Users/leventehuszti/Desktop/BoboPimcoreProject/BoboPimcoreProject/Bobo_Webscraper/chromedriver'
...
getdata(url, pages).to_excel('/Users/leventehuszti/Desktop/test.xlsx')

# output = getdata(url, pages)
# output.to_excel('/home/levi/Desktop/test.xlsx')
#print(output)
